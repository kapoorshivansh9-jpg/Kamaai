...
const en = {
  ...
  "home.tip": "Updated with live surge data · IPL season · Delhi NCR",
  ...
  "ob.gen1": "Reading today's Delhi NCR weather & AQI", "ob.gen2": "Scanning local events — IPL, festivals",
...
const hi: Record<Key, string> = {
  ...
  "home.tip": "लाइव सर्ज डेटा से अपडेटेड · IPL सीज़न · दिल्ली NCR",
  ...
  "ob.gen1": "आज का दिल्ली NCR मौसम व AQI पढ़ रहे हैं", "ob.gen2": "लोकल इवेंट देख रहे हैं — IPL, त्योहार",
...
const pa: Partial<Record<Key, string>> = {
  ...
  "home.tip": "ਲਾਈਵ ਸਰਜ ਡੇਟਾ ਨਾਲ ਅੱਪਡੇਟ · IPL ਸੀਜ਼ਨ · ਦਿੱਲੀ NCR",
  ...
  "ob.gen1": "ਅੱਜ ਦਾ ਦਿੱਲੀ NCR ਮੌਸਮ ਤੇ AQI ਪੜ੍ਹ ਰਹੇ ਹਾਂ", "ob.gen2": "ਲੋਕਲ ਇਵੈਂਟ ਵੇਖ ਰਹੇ ਹਾਂ — IPL, ਤਿਉਹਾਰ",
...
const bn: Partial<Record<Key, string>> = {
  ...
  "home.tip": "লাইভ সার্জ ডেটা সহ আপডেট · IPL মরসুম · দিল্লি NCR",
  ...
  "ob.gen1": "আজকের দিল্লি NCR আবহাওয়া ও AQI পড়ছি", "ob.gen2": "লোকাল ইভেন্ট দেখছি — IPL, উৎসব",
...
const ta: Partial<Record<Key, string>> = {
  ...
  "home.tip": "நேரலை சர்ஜ் தரவுடன் புதுப்பிப்பு · IPL சீசன் · டெல்லி NCR",
  ...
  "ob.gen1": "இன்றைய டெல்லி NCR வானிலை & AQI படிக்கிறோம்", "ob.gen2": "உள்ளூர் நிகழ்வுகளைப் பார்க்கிறோம் — IPL, பண்டிகைகள்",
...
const mr: Partial<Record<Key, string>> = {
  ...
  "home.tip": "लाइव्ह सर्ज डेटासह अपडेट · IPL हंगाम · दिल्ली NCR",
  ...
  "ob.gen1": "आजचे दिल्ली NCR हवामान व AQI वाचत आहोत", "ob.gen2": "लोकल इव्हेंट पाहत आहोत — IPL, सण",
